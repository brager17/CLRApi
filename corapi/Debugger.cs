...
namespace Microsoft.Samples.Debugging.CorDebug
{
    ...
    public sealed class CorDebugger : MarshalByRefObject
    {
        ...
        private void InitFromVersion(string debuggerVersion)
        {
            ...
            if (fUseV2)
            {
                ...
                {
                    rawDebuggingAPI =
                        NativeMethods.CreateDebuggingInterfaceFromVersion((int) CorDebuggerVersion.Whidbey,
                            debuggerVersion);
                }
    ...
    public static class NativeMethods
    {
        ...
        public static extern ProcessSafeHandle OpenProcess(Int32 dwDesiredAccess, bool bInheritHandle,
            Int32 dwProcessId);
    ...
    {
        [return: MarshalAs(UnmanagedType.Interface)]
        System.Object GetRequestedRuntime([In, ComAliasName("metahost.assembly.MetaHostPolicyFlags")]
            CLRMetaHostPolicy.MetaHostPolicyFlags dwPolicyFlags,
    ...
    public sealed class CLRDebugging
    {
        ...
        {
            CorProcess process;
            int hr = TryOpenVirtualProcess(moduleBaseAddress, dataTarget, libraryProvider, maxDebuggerSupportedVersion,
                out version, out flags, out process);
            if (hr < 0)
    ...
    {
        DynamicCorModule m_managedModule;

        public CorModuleEventArgs(CorAppDomain appDomain, DynamicCorModule managedModule)
            : base(appDomain)
        {
        ...
        public DynamicCorModule Module
        {
    ...
    public class CorUpdateModuleSymbolsEventArgs : CorModuleEventArgs
    {
        ...
        public CorUpdateModuleSymbolsEventArgs(CorAppDomain appDomain,
            DynamicCorModule managedModule,
            IStream stream)
    ...
    public class CorNativeStopEventArgs : CorProcessEventArgs
    {
        ...
        {
            get { return m_isOutOfBand; }
        }

        [CLSCompliant(false)]
        public IntPtr DebugEvent
        {
            get { return m_debugEvent; }
        }
            ...
            ICorDebugModule managedModule)
        {
            HandleEvent(ManagedCallbackType.OnModuleLoad,
                new CorModuleEventArgs(appDomain == null ? null : new CorAppDomain(appDomain),
                    managedModule == null ? null : new DynamicCorModule(managedModule),
