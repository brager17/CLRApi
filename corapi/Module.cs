...
namespace Microsoft.Samples.Debugging.CorDebug
{
    ...
    public sealed class DynamicCorModule : WrapperBase
    {
        ...
        private CorDebuggerOptions options = new CorDebuggerOptions();
        ...
        public String GetName()
        {
            ...
            UInt32 fetched;
            m_module.GetName((UInt32) name.Length, out fetched, name);
        ...
        public T GetMetadataInterface<T>()
        {
            ...
            m_module.GetMetaDataInterface(ref guid, out res);
            return (T) res;
        }

        internal DynamicCorModule(ICorDebugModule managedModule)
            : base(managedModule)
        {
